...
const styles = {
  ...
  mealActionBtn: { padding: '4px 10px', borderRadius: 6, border: `1px solid ${C.border}`, background: C.bgCard, fontSize: F.sizes.xs, color: C.textMuted, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 2 },
  mealEmpty: { display: 'flex', gap: 6 },
  addMealBtn: { display: 'flex', alignItems: 'center', gap: 4, padding: '6px 12px', borderRadius: 8, border: `1px dashed ${C.primary}`, background: C.primaryLight, color: C.primary, fontSize: F.sizes.sm, fontWeight: F.weights.semi, fontFamily: F.heading, cursor: 'pointer' },
  randomBtn: { padding: '6px 10px', borderRadius: 8, border: `1px solid ${C.border}`, background: C.bgCard, color: C.textMuted, cursor: 'pointer', display: 'flex', alignItems: 'center' },
