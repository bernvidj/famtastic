      ...
      <div style={styles.content}>
        ...
        {isParent && (
          <div style={styles.card}>
            ...
            <div style={styles.settingRow}>
              <div style={{ flex: 1 }}>
                <span style={styles.settingLabel}>💬 Familjechatt</span>
                <span style={styles.settingDesc}>
                  {getFeature('chat')
                    ? 'Aktiverad — alla kan chatta'
                    : 'Inaktiverad'}
                </span>
              </div>
              <button
                onClick={() => toggleFeature('chat')}
                style={{ ...styles.toggleSwitch, background: getFeature('chat') ? C.secondary : C.border }}
              >
                <div style={{ ...styles.toggleKnob, transform: getFeature('chat') ? 'translateX(22px)' : 'translateX(2px)' }} />
              </button>
            </div>
            ...
            <div style={styles.settingRow}>
              <div style={{ flex: 1 }}>
                <span style={styles.settingLabel}>📊 Familjeomröstning</span>
                <span style={styles.settingDesc}>
                  {getFeature('poll')
                    ? 'Aktiverad — föräldrar kan skapa omröstningar i chatten'
                    : 'Inaktiverad'}
                </span>
              </div>
              <button
                onClick={() => toggleFeature('poll')}
                style={{ ...styles.toggleSwitch, background: getFeature('poll') ? C.secondary : C.border }}
              >
                <div style={{ ...styles.toggleKnob, transform: getFeature('poll') ? 'translateX(22px)' : 'translateX(2px)' }} />
              </button>
            </div>
            ...
            <div style={styles.settingRow}>
              <div style={{ flex: 1 }}>
                <span style={styles.settingLabel}>😊 Familjestämning</span>
                <span style={styles.settingDesc}>
                  {getFeature('mood')
                    ? 'Aktiverad — daglig stämningskoll i chatten'
                    : 'Inaktiverad'}
                </span>
              </div>
              <button
                onClick={() => toggleFeature('mood')}
