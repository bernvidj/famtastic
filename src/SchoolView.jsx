...
export function SchoolView({ familyId, member, members }) {
  ...
  async function saveExam() {
    ...
    // 2. Auto-generate study chores (one per day for study_days before exam)
    ...
    for (let i = studyDays; i >= 1; i--) {
      ...
      choresToInsert.push({
        ...
        chore_type: 'base',
        is_recurring: false,
        assigned_to: addingExam.id,
        scheduled_date: dateStr,
        reference_id: examData.id,
        difficulty: 'medium',
  ...
  // Subjects available for the selected child (for exam form)
          ...
          <div style={styles.modal}>
            ...
            <div style={styles.modalFooter}>
              ...
              <button onClick={saveExam}
                disabled={!examForm.title.trim() || !examForm.exam_date}
